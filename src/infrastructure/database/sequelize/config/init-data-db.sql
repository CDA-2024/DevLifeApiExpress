...
(1, 'Ordinateur Basique', 'Matériel', 'PC de bureau standard pour tâches courantes', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(2, 'Ordinateur Gaming', 'Matériel', 'PC avec carte graphique haut de gamme pour gamers', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(3, 'MacBook Pro', 'Matériel', 'Ordinateur portable puissant pour les développeurs', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(4, 'Ordinateur Portable Classique', 'Matériel', 'Laptop adapté au télétravail', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(5, 'PC de Bureau Haute Performance', 'Matériel', 'Station de travail pour graphistes et devs', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(6, 'Chaise Classique', 'Mobilier', 'Chaise de bureau simple et confortable', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(7, 'Chaise Ergonomique', 'Mobilier', 'Chaise avec support lombaire et accoudoirs réglables', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(8, 'Chaise de Luxe', 'Mobilier', 'Chaise haut de gamme avec coussins mémoire de forme', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(9, 'Fauteuil Gamer', 'Mobilier', 'Chaise avec appui-tête et repose-pieds intégré', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(10, 'Chaise en Cuir Premium', 'Mobilier', 'Chaise en cuir véritable pour un confort ultime', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(11, 'Bureau Classique', 'Mobilier', 'Bureau en bois simple avec tiroirs intégrés', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(12, 'Bureau Assis-Debout', 'Mobilier', 'Bureau réglable en hauteur pour alternance debout-assis', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(13, 'Bureau de Luxe', 'Mobilier', 'Bureau en bois massif avec finitions premium', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(14, 'Bureau Compact', 'Mobilier', 'Petit bureau pratique pour espace réduit', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(15, 'Bureau avec Rangement', 'Mobilier', 'Bureau avec plusieurs tiroirs et étagères intégrés', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(16, 'Écran Classique', 'Matériel', 'Écran 24 pouces Full HD', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(17, 'Écran 4K', 'Matériel', 'Écran 27 pouces Ultra HD 4K', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(18, 'Écran Incurvé', 'Matériel', 'Écran 32 pouces incurvé pour immersion maximale', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(19, 'Écran UltraWide', 'Matériel', 'Écran 34 pouces ultra-large pour multitâche', 'https://picsum.photos/200/300', NOW(), NOW(), false),
(20, 'Écran Tactile', 'Matériel', 'Écran tactile Full HD interactif', 'https://picsum.photos/200/300', NOW(), NOW(), false);
